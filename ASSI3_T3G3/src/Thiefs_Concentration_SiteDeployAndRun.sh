...
#sshpass -f password scp dirConcentrationSite.zip sd202@l040101-ws07.ua.pt:test/MuseumHeist
#echo "Decompressing data sent to the Thiefs Concentration Site node."
#sshpass -f password ssh sd202@l040101-ws07.ua.pt 'cd test/MuseumHeist ; unzip -uq dirConcentrationSite.zip'
#sshpass -f password scp genclass.zip sd202@l040101-ws07.ua.pt:test/MuseumHeist/dirConcentrationSite
#sshpass -f password ssh sd202@l040101-ws07.ua.pt 'cd test/MuseumHeist/dirConcentrationSite ; unzip -uq genclass.zip'
#echo "Executing program at the Thiefs Concentration Site node."
#sshpass -f password ssh sd202@l040101-ws07.ua.pt 'cd test/MuseumHeist/dirConcentrationSite ; ./concentrationSite_com_d.sh sd202'
#echo "Thiefs Concentration Site Server shutdown."
