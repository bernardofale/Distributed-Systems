...
public class ServerMuseum {
    ...
    {
        Museum m;                                              // museum (service to be rendered)
        MuseumInterface MInter;                                // interface to the museum
        ...
        m = new Museum (reposStub);                                      // service is instantiated
        MInter = new MuseumInterface(m);                            // interface to the service is instantiated
        ...
        MuseumProxy cliProxy;                                // service provider agent

        waitConnection = true;
        while (waitConnection)
        { try
        { sconi = scon.accept ();                                    // enter listening procedure
            cliProxy = new MuseumProxy(sconi, MInter);    // start a service provider agent to address
